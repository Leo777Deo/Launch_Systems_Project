...
x_b1f = GEOMETRY.b1*2/3; % fairing
x_b1 = GEOMETRY.b1/2;%pay+adapt
...
x_vec = [x_b1f;x_b1;x_b2;x_b3;x_b_fuel_2;x_b4;x_b_lox_2;x_b5];

m_vec = [GEOMETRY.m_fair;abs(GEOMETRY.m1-GEOMETRY.m_fair);GEOMETRY.m2;GEOMETRY.m_tank_f_2;m_fuel_2t;GEOMETRY.m_tank_lox_2;m_lox_2t;GEOMETRY.m5];

X_COM_t = (dot(x_vec,m_vec)/(sum(m_vec)));
GEOMETRY.X_COM_t=X_COM_t;

xb1 = abs(x_b1-X_COM_t);
xb1f = abs(x_b1f-X_COM_t);
...
x_vec_J = [xb1f;xb1;xb2;xb3;xb_fuel_2;xb4;xb_lox_2;xb5];
...
r_vec = [Rb1f;Rb1;Rb2;Rb3;Rb_fuel_2;Rb4;Rb_lox_2;Rb5];
